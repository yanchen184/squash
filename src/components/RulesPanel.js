    ...
    <div className="rules-panel">
      ...
      {open && (
        <div className="rules-content">
          ...
          <ul>
            <li>同分名次看的是<b>直接對戰勝負與比分</b>,不是總分;<b>所有名次都適用</b>(含 1/2 名)</li>
            <li><b>Round 1 末 2 人同分</b>:用 <b>Round 2 第一次交手</b>的勝負決定
              <ul>
                <li>系統會把同分兩人<b>優先排進 Round 2 前兩場</b>對戰 — 前兩場大家累積 0 勝、<b>無讓分</b>,勝負最乾淨(兩組同分則各佔一場)</li>
              </ul>
            </li>
