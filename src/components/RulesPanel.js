    ...
    <div className="rules-panel">
      ...
      {open && (
        <div className="rules-content">
          ...
          <h4>Tie-break (加賽規則)</h4>
          <ul>
            <li><b>Round 1 末 2 人同分</b> (2/3 或 3/4 名):用 <b>Round 2 第一次交手</b>的勝負決定</li>
            <li><b>Round 1 末 3 人同分</b>:用 <b>Round 2 第 1 輪</b>那 3 人 H2H 決定
              <ul>
                <li>H2H 勝場均等 → 比累積得分 (deuce 視 <b>8:6</b>)</li>
                <li>得分一致 → 被讓分多的輸</li>
                <li>還比不出來 → 猜拳</li>
              </ul>
            </li>
            <li><b>Round 2 末 2 人同分</b>:用 <b>Round 2 第 3 輪</b>那兩人第一次交手結果決定</li>
            <li><b>Round 2 末 3 人同分</b>:用 <b>Round 2 第 3 輪</b>那 3 人 H2H 同上規則決定</li>
          </ul>
        </div>
      )}
    </div>
